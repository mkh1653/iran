...
export const CELEBRITIES_DATA: Celebrity[] = [
  {
    ...
    description:
      "ابوعلی سینا، معروف به ابن سینا، یکی از بزرگترین پزشکان و فیلسوفان تاریخ ایران و جهان است. او در زمینه‌های مختلف علمی و فلسفی آثار ارزشمندی ارائه داده است.",
    birth: "359 خورشیدی - بخارا",
    death: "416 خورشیدی - همدان",
  ...
  // },
  {
    ...
    description:
      "فردوسی، شاعر بزرگ حماسه‌سرای ایران، در قرن چهارم هجری می‌زیست و بیشتر عمر خود را صرف سرودن شاهنامه کرد. شاهنامه با بیش از ۵۰ هزار بیت، تاریخ، اسطوره‌ها و فرهنگ ایران باستان را در قالب شعری ماندگار روایت می‌کند. او یکی از مهم‌ترین پاسداران زبان و هویت فارسی به شمار می‌رود و تأثیر بزرگی بر فرهنگ و ادبیات ایران داشته است.",
    birth: "۳۱۹ خورشیدی - طوس",
    death: "۳۹۹ خورشیدی - طوس",
    imageUrl: "/bust-ferdowsi.png",
  },
];
