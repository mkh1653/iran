...
export const CELEBRITIES_DATA: Celebrity[] = [
  {
    ...
    description: "ابوعلی سینا، معروف به ابن سینا، یکی از بزرگترین پزشکان و فیلسوفان تاریخ ایران و جهان است. او در زمینه‌های مختلف علمی و فلسفی آثار ارزشمندی ارائه داده است.",
